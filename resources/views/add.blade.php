                        ...
                        <form action="{{route('article_add')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text"
                                    ...
                                    id="title" value="{{old('title')}}" name="title" placeholder="Name">
                                @if($errors->any())
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="description" value="" cols="10" rows="8"
                                    ...
                                    id="description" placeholder="description">{{old('discription')}}</textarea>
                                @if($errors->any())
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text"
                                    ...
                                    id="author" value="{{old('author')}}" placeholder="Author" name="author">
                                @if($errors->any())
